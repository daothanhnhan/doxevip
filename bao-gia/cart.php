  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      {  
           ...
           {                                               
            $d++;
            $product = $action->getDetail('product', 'product_id', $values['product_id']);
      ?>
      ...
      <tr>
        ...
        <td><?= $product['product_sub_info4'] ?></td>

        <td style="vertical-align: middle;"><?= $product['product_expiration'] ?></td>

        

        <td style="vertical-align: middle;"><?= $values['product_quantity'] ?></td>

        

        <td style="vertical-align: middle;"><?= number_format($values['product_price']) ?></td>

        <td style="vertical-align: middle;"><?= number_format($values['product_price'] * $values["product_quantity"]) ?></td>
