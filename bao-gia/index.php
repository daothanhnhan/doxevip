<?php 
  ...
  $gia = $product['product_price']-($product['product_price']*($product['product_price_sale']/100));
  $vat = $gia * 0.1;
  $tong_thanh_toan = $gia + $vat;
?>
...
<div class="mainmain">
  <div class="container-fluid">
    <p style="margin-bottom: 0;">Kính gửi: </p>
    <p style="margin-bottom: 0;">Địa chỉ: </p>
    <p style="margin-bottom: 0;">Fax/Tel: </p>
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="vertical-align: middle;"><?= number_format($product['product_price']-($product['product_price']*($product['product_price_sale']/100))) ?></td>
      ...
      <tr>  
           ...
           <td align="right"><?php echo number_format($product['product_price']-($product['product_price']*($product['product_price_sale']/100))); ?></td>    
      </tr>
      ...
      <tr>  
           ...
           <td align="right"><?php echo number_format($tong_thanh_toan); ?></td>    
      </tr>
