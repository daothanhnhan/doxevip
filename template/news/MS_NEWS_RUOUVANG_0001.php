...
<div class="gb-page-blog_ruouvang">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="gb-news-blog_ruouvang-item">
                            <div class="gb-news-blog_ruouvang-item-img col-md-4 col-xs-12" style="padding-left: 0">
                                <a href="/<?= $rowLang['friendly_url'] ?>"><img src="/images/<?= $item['news_img'] ?>" alt="<?= $rowLang['lang_news_name'] ?>" class="img-responsive"></a>
                               <!--  <div class="caption caption-large">
                                   
                                </div> -->
                            </div>
                            <div class="gb-news-blog_ruouvang-item-text col-md-8 col-xs-12">
            ...
            <div class="col-md-4">
                <?php include DIR_SIDEBAR."MS_SIDEBAR_MPTOTO_0002_1.php";?>
                <?php include DIR_SIDEBAR."MS_SIDEBAR_MPTOTO_0003.php";?>
                <?php include DIR_SIDEBAR."MS_SIDEBAR_RUOUVANG_0003.php";?>
            </div>
        </div>
