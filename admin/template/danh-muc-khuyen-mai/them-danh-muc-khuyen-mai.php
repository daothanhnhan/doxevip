<?php 
	...
	function khuyen_mai () {
		...
		if (isset($_POST['add_sale'])) {
			...
			$sql = "INSERT INTO sale_cat (name, image, link) VALUES ('$name', '$image', '$link')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một chương trình khuyến mãi.\');window.location.href="index.php?page=danh-muc-khuyen-mai"</script>';
			} else {
