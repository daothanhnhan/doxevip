<?php 
	...
	function tinh_nang_item ($id) {
		...
		if (isset($_POST['add_tinhnang'])) {
			...
			$sql = "UPDATE tinh_nang_item SET name = '$name' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một tinh năng.\')</script>';
			} else {
	...
	tinh_nang_item($_GET['id']);

	$info = $action->getDetail('tinh_nang_item', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=tinh-nang-item&tinh_nang_cat_id=<?= $info['tinh_nang_cat_id'] ?>">Quay lại</a><br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <img src="/images/tinh-nang/<?= $info['image'] ?>" alt="" width="200">
