<?php 
    ...
    // $productcat_kv = $kiotviet->get_detail_procat($_GET['id_kv']);//var_dump($productcat_kv);
...
<form action="" method="post" accept-charset="utf-8" id="addProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" id="title" onchange="ChangeToSlug()" value="<?= $productcat_kv['categoryName'];?>" name="productcat_name"/>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Home tab danh mục sản phẩm</span>

            <p class="subLeftNCP">Thiết lập home tab cho danh mục sản phẩm</p>

        </div>

        <div class="boxNodeContentPage">

            <p class="titleRightNCP">Home tab</p>
            <select name="home_tab" class="txtNCP1">
                <option value="0">== chọn home tab ==</option>
                <?php foreach ($home_tab as $item) { ?>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="number" class="txtNCP1"  name="productcat_sort_order" value="0" required/>
        </div>
    </div><!--end rowNodeContentPage-->
    <div class="rowNodeContentPage">
        <div class="leftNCP">
