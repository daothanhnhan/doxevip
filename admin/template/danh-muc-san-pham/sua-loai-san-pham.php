...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <select name="home_tab" class="txtNCP1">
                ...
                <option value="<?= $item['id'] ?>" <?= $item['id'] == $row['home_tab'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                <?php } ?>
            </select>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="number" class="txtNCP1"  name="productcat_sort_order" value="<?php echo $row['productcat_sort_order']?>" required/>
        </div>
    </div><!--end rowNodeContentPage-->
