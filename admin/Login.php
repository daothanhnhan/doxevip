...
<div id="divWrapper">
    <div class="coverFormLogin">
        <form method="post" class="formLogin" id="formLogin">
            ...
            <img src="/images/logo/logo.jpg" alt="GoldBridge" class="logoLogin" style="width: 48%;" /> 
            <div class="boxForm">
        ...
        <p class="endLogin">Công ty TNHH Phát Triển Thương Hiệu Cafelink Việt Nam<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>0865689886</strong> - <em style="text-decoration:underline;">Email:</em> <strong>kinhdoanh@cafelink.org</strong><br /><em style="text-decoration:underline;">Website:</em> cafelink.org</p>
