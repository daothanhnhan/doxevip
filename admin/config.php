...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Thông tin tài khoản ngân hàng</p>
            ...
            <p class="titleRightNCP">Liên hệ ngay với chúng tôi</p>
            <!-- <input type="text" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home10']?>" name="content_home10"/> -->
            <textarea name="content_home10" id="input" class="form-control" rows="3"><?php echo $row_showMain['lang_content_home10']?></textarea>

            <p class="titleRightNCP">Chiết khấu áp dụng mã giảm giá</p>
            <input type="number" class="txtNCP1" value='<?php echo $row_showMain['lang_content_home9']?>' name="content_home9" required/>
			
            <p class="titleRightNCP">Giao hàng</p>
            <!-- <input type="text" class="txtNCP1" value="<?php echo $row_showMain['facebook']?>" name="facebook"/> -->
            <textarea name="facebook" id="input" class="form-control" rows="3"><?php echo $row_showMain['facebook']?></textarea>
