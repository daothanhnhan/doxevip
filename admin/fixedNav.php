          ...
          <!--  <li><a href="index.php?page=danh-muc-dich-vu" title=""
           ...
           <!-- <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Ý kiến khách hàng</a></li> -->
            ...
            <!-- <li><a href="index.php?page=tag-san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tag-san-pham' || $_GET["page"] == 'them-tag-san-pham' || $_GET["page"] == 'sua-tag-san-pham') {
                       echo 'sltMenu';
                   } ?>"><img src="image/product2.png" class="iconMenu2"/><img src="image/product.png"
                                                                               class="iconMenu"/>Thẻ tag sản phẩm</a>
            </li> -->
            ...
            <!-- <li><a href="index.php?page=bao-hanh" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Bảo hành</a>
            </li> -->

            <!-- <li><a href="index.php?page=home-tab" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Home tab</a>
            </li> -->
            ...
            <!-- <li><a href="index.php?page=dong-bo-san-pham" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đồng bộ sản phẩm</a>
            </li> -->

            <!-- <li><a href="index.php?page=danh-muc-khuyen-mai" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục khuyến mãi</a>
            </li> -->
            ...
            <!-- <li><a href="index.php?page=thuoc-tinh" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thuộc tính</a>
            </li> -->

            <li><a href="index.php?page=nhap-san-pham" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhập sản phẩm</a>
            </li>
    ...
    <div class="rightFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "tag-san-pham":
                    echo "<a href='index.php?page=them-tag-san-pham' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;

                case "sua-tag-san-pham":
                    echo "<a class='btnTop btnAddTop' href='index.php?page=tag-san-pham'>Quay lại</a>";
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-tag-san-pham'>Thêm mới</a>";
                    break;
...
<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="/images/logo/logo.jpg" class="imgLogoTop" style="width: 66%;" /></a>
