 ...
 {  
      ...
      {  
           ...
           {  
                $order_table .= '  
                     <tr>  
                          <td><img src="'.$values["product_link"].'" alt="" width="50"></td>  
                          <td>'.$values["product_name"].'</td>  
                          <td style="display:none;"><span class="btn btn-warning" onclick="doi_sp('.$values["product_id"].')">Đổi sản phẩm</span></td>
                          ...
                          <td><button name="delete" class="btn btn-danger btn-xs delete" id="'.$values["product_id"].'">Xóa xản phẩm</button></td>  
                     </tr>  
                ';  
