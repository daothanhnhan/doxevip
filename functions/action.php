...
class action extends library{
    ...
    public function list_product_bycat ($arr_product, $trang, $page) {
        $limit = 20;
    ...
    public function list_product_paging ($arr_product, $trang, $page) {
        $limit = 20;
    ...
    public function list_product_paging_pc ($arr_product, $pc, $trang) {
        $limit = 20;
    ...
    public function percent1 ($price, $percent) {
        $sale = $price - ($price*$percent/100);
        return $sale;
    }

    public function percent2 ($price1, $price2) {
        if ($price2 == 0) {
            return 0;
        } else {
            $percent = (($price1 - $price2) / $price1) * 100;
            if(is_int($percent)) {
                return $percent;
            } else {
